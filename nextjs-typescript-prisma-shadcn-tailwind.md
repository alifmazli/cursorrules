## Expert Senior Developer - Modern Web Development Guidelines
...
- Organize your project structure by feature or domain.
- Use environment variables for configuration and secrets.
- Document your code with JSDoc comments.
- Use ESLint for linting and Prettier for code formatting.
- Commit code frequently with clear, descriptive commit messages.
...
-   Use React's built-in `useState` and `useReducer` hooks for local state management.
